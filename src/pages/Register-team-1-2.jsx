...
function Register_team_1_2() {    
  ...
  const handleChange = (e) => {
    updateValue(e.target.nextElementSibling.innerText);
  }

  const handleSubmit = async (e) => {
    navigate(`/register-team-1-3?teamName=${urlParams.get("teamName")}&teamAdmin=${urlParams.get("teamAdmin")}&paymentMethod=${values.paymentMethod == '' ? 'Free' : values}`);
  };
        ...
        <form className="user" onSubmit={(event) => handleSubmit(event)}>
          <div className="form-check">
            ...
            <label
              data-toggle="tooltip"
              data-placement="top"
              title="The best way for starting teams"
              className="form-check-label h4 pl-2"
          ...
          <div className="form-check">
            ...
            <label
              ...
              data-toggle="tooltip"
              data-placement="top"
              title="All benefits for free, and many more. Only for $5.25/mo"
          ...
          <div className="form-check">
            ...
            <label
              data-toggle="tooltip"
              data-placement="top"
              title="All benefits for Pro, and many more. Only for: $10.25/mo"
              className="form-check-label h4 pl-2"
...
export default Register_team_1_2