...
function Register_team_1_1() {
  let adminTeam = localStorage.getItem('divert-user')
  adminTeam = JSON.parse(adminTeam);
  ...
  const handleSubmit = async (e) => {
    ...
    if(handleValidation()){   
        navigate(`/register-team-1-2?teamName=${teamName}&teamAdmin=${adminTeam._id}`);
    }
  };

  const handleValidation = () =>{
    if(teamName === ""){
      toast.error("Team Name is required.", toastOptions);
      return false;
    }
    return true;
  }
          ...
          <Col className="col-lg-6 column-first shadow-lg">
            <div className="p-5">
              ...
              <a id="divert-logo-app-id"className="navbar-brand align-items-center" href="/divert" style={{ marginLeft: '0' }}>
                ...
                <h4 className="text-dark mb-4" style={{ marginTop: '30px' }}>Welcome to Divert. Register your new Team.</h4>
                <p className="mb-4" style={{marginTop: "-15px", color: "gray"}}>Write your team name here.</p>
              </div>
            <Form className="user" onSubmit={(event) => handleSubmit(event)}>
              <div className="form-group mb-4">
                <input className="form-control form-control-user" type="text" id="teamName" placeholder="Enter Teams name" name="teamName" onChange={(e) => handleChange(e)} />
              </div>
...
export default Register_team_1_1