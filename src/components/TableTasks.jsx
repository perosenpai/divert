...
import { getTeams, getTasks, deleteTask, usersInTeam, updateTask, getGroups } from '../utils/APIRoutes';
      ...
      editTasksBtns.forEach(btn => {
        btn.addEventListener('click', async (e) => {
          ...
          groups.data?.forEach(group => {
            document.querySelector('#select-id-edit').innerHTML += `<option>${group.newGroupObj.name}</option>`
          })
          //task
          // removeTask(e, btn.parentElement.parentElement.parentElement.getAttribute('id'));
        })
